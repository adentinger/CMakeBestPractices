...
# cd "${SCRIPT_DIR}" && cmake --workflow --preset ninja-release-static && cmake --install build
cd "${SCRIPT_DIR}" && cmake --workflow --preset ninja-release-shared && cmake --install build
