...
run_or_print "${CMAKE_CMD}" --build build --config "${ADECLANGFORMAT_CONFIG}"
run_or_print "${CTEST_CMD}" --test-dir build --build-config "${ADECLANGFORMAT_CONFIG}"
...
run_or_print "${CMAKE_CMD}" --build build --config "${PRJ1_CONFIG}"
run_or_print "${CTEST_CMD}" --test-dir build --build-config "${PRJ1_CONFIG}"
...
run_or_print "${CMAKE_CMD}" --build build --config "${PRJ2_CONFIG}"
run_or_print "${CTEST_CMD}" --test-dir build --build-config "${PRJ2_CONFIG}"
