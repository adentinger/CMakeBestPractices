...
# cd "${SCRIPT_DIR}" && cmake --workflow --preset ninja-release-static && cmake --install build && ./build/exe/exe
cd "${SCRIPT_DIR}" && cmake --workflow --preset ninja-release-shared && cmake --install build && ./build/exe/exe
